...
const FretboardGrid: React.FC<FretboardGridProps> = ({ fretboardData, showRoots, showTriads, fretCount = 22 }) => {
    ...
    <div className="w-full flex flex-col flex-1">
      ...
      <div className="w-full overflow-x-auto pb-8 custom-scrollbar">
        <div className="flex">
          ...
          <FretboardGrid fretboardData={fretboardData} showRoots={showRoots} showTriads={showTriads} fretCount={22} />
